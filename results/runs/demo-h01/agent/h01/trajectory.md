...
**Attempt 1** — parse: patched, verify: failed, guard: skipped → rejected (still-failing)  _(1942+95 tok, 930ms)_
**Attempt 2** — parse: patched, verify: passed, guard: hollow → rejected (hollow)  _(2492+104 tok, 972ms)_
**Attempt 3** — parse: patched, verify: failed, guard: skipped → rejected (still-failing)  _(2153+95 tok, 973ms)_
