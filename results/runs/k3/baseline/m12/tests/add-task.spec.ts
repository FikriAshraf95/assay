...
test('adds a task to the list', async ({ page }) => {
  ...
  // The composer lives inside a collapsed <details>; expand it first so the
  // input becomes visible and editable.
  await page.locator('summary.composer-summary').click();
